...
class Ui_QueryForm(object):
    def setupUi(self, QueryForm):
        ...
        self.tab_simple.setEnabled(False)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 506, 99))
        ...
        self.verticalLayout_2.addLayout(self.field_query_line)
